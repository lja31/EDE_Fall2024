...
# maximum value of vector 1
max(vector1)

#Create another vector of the values 10 thru 15
vector4 <- c(10:15)

# Combine vectors with same data 
c(vector1, vector4)

# vector multiplication 
vector1 * vector4

#multiply all elements in vector1 by 10
vector1 * 10

#changing lowercase to upper case of characters. 
toupper(vector2) 

#denying or opposite of vector2
!vector3
...
matrix1[c(12, 14)] # elements 

matrix1[c(12:14)] # list all elements 12 13 14

matrix1[2:4, 1:3] # small sub matrix in the bigger matrix 3 rows 3 columns 
...
matrix4 # 2x3 matrix elements organized
...
#name of object in the list
list1$age

#
names(list1)

#2 objects from list each element in the list is object in itself
list1[1:2]

#
list1$name = "Janelle"

#value of specific element in the object 
list1[[4]] = 44
list1
```
...
# Data Frames ---- must have same number of rows 
...
#Combine the vectors into a dataframe function(data.frame)
