...
#Set the URL
theURL <- 
  'https://waterdata.usgs.gov/nwis/uv?search_site_no=02087500&period=24&format=rdb'
...
df <- data.frame(the_states = the_states,
                             the_price = as.numeric(gsub(",","",the_price)),
                             the_capacity = as.numeric(gsub(",","",the_capacity)),
