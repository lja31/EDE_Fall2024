...
print(geom_density_ozone) 


geom_box_ozone <- ggplot(EPAair, aes(x = as.factor(Year) , y = Ozone)) +
  geom_boxplot() 
  
print(geom_box_ozone)

geom_violin_ozone <- ggplot(EPAair, aes(x = as.factor(Year) , y = Ozone)) +
  geom_violin(draw_quantiles = 0.5)
 
print(geom_violin_ozone)
...
PM2.5_regression_plot <- 
  ggplot(EPAair, aes(x = Ozone, y = PM2.5)) +
  geom_point() 
print(PM2.5_regression_plot) 

PM2.5_regression_plot2 <- 
  ggplot(EPAair, aes(x = Ozone, y = PM2.5)) +
  geom_smooth(method = "lm") +
  #geom_text(x=100, y=75, label =expression("PM2.5 = 0.38 * Ozone+15.64"))
  geom_point() 
print(PM2.5_regression_plot2) 
...
EPAair_corrolation <- 
  ...
  na.omit()
EPAair_corrolation2 <- cor(EPAair_corrolation)
corrplot(EPAair_corrolation2, upper = "ellipse")
...
OzoneAll.reg2 <- lm (data=EPAair, PM2.5 ~ Ozone +  Month + mean_Lng + mean_Lat)
summary(OzoneAll.reg2)
