...
#11
write.csv(spread_dataset, file.path("/home/guest/EDE_Fall2024/Data/Processed/EPAair_O3_PM25_NC1819_Processed.csv"), row.names = FALSE)
...
> Answer: We used the drop_na function over na.omit because drop_na allows us to selectively
remove rows with missing values based on specific columns, offering more flexibility and customization.
In our case, we wanted to retain rows with missing PM2.5 values while removing
rows with missing ozone values, aligning with our data processing requirements.
