...
plot_tp <- NTL.LTER.Lake.Chemistry.Nutrients.PeterPaul %>% 
  ...
  geom_boxplot(color = lakename) +
  labs(y = "Total Phosphorus_TP") +
  theme_minimal() +
  theme(
    axis.title.x = element_blank(),
    legend.position = "none"
...
combined_plot <- plot_grid(
  plot_temp + theme(legend.position = "none"),  # Remove legend from this plot
  plot_tp + theme(legend.position = "none"),    # Remove legend from this plot
...
ggplot(needles_datasubset, aes(x = collectDate, y = dryMass, color = nlcdClass)) +
geom_line() +
labs(
