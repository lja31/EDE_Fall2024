...
> Answer:Population, Mortality, Behavior, Feeding behavior, Repordouction, Development, Avoidence. 
...
class(Litter$collectDate) #check the class
...
```{r}
#Determine how many different plots sampled at Niwot Ridge using unique function and length.
